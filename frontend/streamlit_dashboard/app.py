...
# --- DATA LOADER ---
# Use the Indian School Student Dataset as the primary source (TAB separated)
...
if os.path.exists(data_path):
    ...
    if 'Gender' in df_raw.columns:
        ...
        # Drop rows where Gender matches the header (occurs in some broken TAB files)
        df_raw = df_raw[df_raw['Gender'] != 'Gender']
        df_raw = df_raw[df_raw['Gender'] != 'nan']
